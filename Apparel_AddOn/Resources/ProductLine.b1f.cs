...
{
    [FormAttribute("Apparel_AddOn.Resources.ProductLine", "Resources/ProductLine.b1f")]
    class ProductLine : UserFormBase
    {
        ...
        public override void OnInitializeComponent()
        {
            ...
            this.ComboBox0 = ((SAPbouiCOM.ComboBox)(this.GetItem("CBGENDER").Specific));
        ...
        private bool ValidateForm(ref SAPbouiCOM.Form oForm, ref bool BubbleEvent)
        {
            ...
            string active = oForm.DataSources.DBDataSources.Item("@FIL_MH_OPLM").GetValue("U_ACTIVE", 0);
            if (code == "")
            {
            ...
            {
                Global.GFunc.ShowError("Enter Product Line Name");
