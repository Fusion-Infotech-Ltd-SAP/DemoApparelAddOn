...
{
    [FormAttribute("Apparel_AddOn.Resources.MasterLCAmendment", "Resources/MasterLCAmendment.b1f")]
    class MasterLCAmendment : UserFormBase
    {
        public MasterLCAmendment()
        {
        }
        ...
        private SAPbouiCOM.EditText ETCUSTMR, ETLCVAL, ETBPBNK2, ETBPBNM2, ETSTFULL, ETRSCAMT, ETSTATUS, ETCDNAME, ETSCVAL, ETSCNO, ETSCNTRY, ETLCNO, ETDESC, ETADNTNO, ETISSBNK, ETIBNKNM, ETNEGBNK, ETNGBNAM, ETVALUE, ETCURR, ETDOCNUM, ETDOCDAT, ETSHIPDT, ETEXDATE, ETB2BLCP, ETCONVAL, ETISUDAT, ETREMRKS, ETDOCTRY;
        private SAPbouiCOM.Folder FOLCUSPO, FOLAMDHS, FOLATTAC;
        private SAPbouiCOM.Matrix MTXCUSPO, MTXATTAC;
        private SAPbouiCOM.Grid GRIDAMND;
        ...
        public override void OnInitializeComponent()
        {
            ...
            this.GRIDAMND = ((SAPbouiCOM.Grid)(this.GetItem("GRIDAMND").Specific));
        ...
        private bool ValidateForm(ref SAPbouiCOM.Form oForm, ref bool BubbleEvent)
        {
            ...
            if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_UPDATE_MODE)
            {
                ...
                string sqlQuery = $"SELECT \"U_CLCTTS\" FROM \"@FIL_DH_OLCM\" WHERE \"DocNum\" = {dnum}";
            ...
            try
            {
                if (pVal.ItemUID == "CBDCTYPE")
                {
                    ...
                    if (selectedValue == "LC")
                    {
                        ...
                        oForm.Items.Item("ETLCVAL").Enabled = true;
        ...
        {
            SAPbouiCOM.Form oFrom = Application.SBO_Application.Forms.Item("FIL_FRM_MLC_AMEND");
        ...
        {
            SAPbouiCOM.Form oForm = Application.SBO_Application.Forms.Item("FIL_FRM_MLC_AMEND");
        ...
        private void ADDButton_PressedAfter(object sboObject, SAPbouiCOM.SBOItemEventArg pVal)
        {
            ...
            if (oForm.Mode == SAPbouiCOM.BoFormMode.fm_OK_MODE)
            {
                try
                {
                    ...
                    SAPbouiCOM.EditText oEditLCNO = (SAPbouiCOM.EditText)oForm.Items.Item("ETLCNO").Specific;
...
ORDER BY ""U_LCAMDNO"" DESC";
                    ...
                    SAPbouiCOM.DataTable dt = oForm.DataSources.DataTables.Item("DTAMEND");
                    dt.ExecuteQuery(sqlQuery);

                    // Bind the Grid
                    SAPbouiCOM.Grid grid = (SAPbouiCOM.Grid)oForm.Items.Item("GRIDAMND").Specific;
                    grid.DataTable = dt;
