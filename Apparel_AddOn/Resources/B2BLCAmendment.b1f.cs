...
{
    [FormAttribute("Apparel_AddOn.Resources.B2BLCAmendment", "Resources/B2BLCAmendment.b1f")]
    class B2BLCAmendment : UserFormBase
    {
        public B2BLCAmendment()
        {
        }
        ...
        {
            SAPbouiCOM.Form oFrom = Application.SBO_Application.Forms.Item("FIL_FRM_B2BLC_AMEND");
        ...
        {
            SAPbouiCOM.Form oForm = Application.SBO_Application.Forms.Item("FIL_FRM_B2BLC_AMEND");
        ...
        private void MTXPIDAT_ChooseFromListAfter(object sboObject, SAPbouiCOM.SBOItemEventArg pVal)
        {
            try
            {
                ...
                if (oDataTable.Rows.Count > 0)
                {
                    ...
                    string value = oDataTable.GetValue("DocTotalFC", 0).ToString();
        ...
        {
            SAPbouiCOM.Form ofrm = Application.SBO_Application.Forms.Item("FIL_FRM_B2BLC_AMEND");
            if (ofrm.Mode == SAPbouiCOM.BoFormMode.fm_OK_MODE)
            {
                try
                {
                    ...
                    SAPbouiCOM.EditText oEditLCNO = (SAPbouiCOM.EditText)ofrm.Items.Item("ETB2LCNO").Specific;
                    ...
                    string sqlQuery = $@"
SELECT 
    ROW_NUMBER() OVER (ORDER BY ""U_BTBAMNO"" DESC) AS ""#"",  -- serial number
    ""U_BTBAMNO"" AS ""AMDNO"",
    ""U_LCNo"" AS ""B2BLCNo"",
    ""U_IssueBank"" AS ""IssuBank"",
    ""U_SUPPBANK"" AS ""NegBank"",
    ...
    ""U_PTerm1"" AS ""Payment"",
    ""U_PTerm2"" AS ""Days"",
    ""U_INCOTRMS"" AS ""IncoTerms"",
    ""U_HSCODE"" AS ""HSCODE""
    
FROM ""@FIL_DH_OLCB""
WHERE ""U_LCNo"" = '{lcNoValue}'
ORDER BY ""U_BTBAMNO"" DESC";
