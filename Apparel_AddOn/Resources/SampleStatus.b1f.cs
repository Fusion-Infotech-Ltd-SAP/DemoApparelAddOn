...
{
    [FormAttribute("Apparel_AddOn.Resources.SampleStatus", "Resources/SampleStatus.b1f")]
    class SampleStatus : UserFormBase
    {
        ...
        private bool ValidateForm(ref SAPbouiCOM.Form oForm, ref bool BubbleEvent)
        {
            try
            {
                ...
                {
                    string docEntry = oForm.DataSources.DBDataSources.Item("@FIL_MH_SMPLSTAT").GetValue("DocEntry", 0).Trim();
